...
RESPONSES = {
    'https://api.gandi.net/v5/livedns/domains': {
        ...
        'body': [{'domain_href': 'https://api.gandi.net/v5/livedns/domains/iheartcli.com',  # noqa
    ...
    'https://api.gandi.net/v5/livedns/domains/iheartcli.com': {
        ...
        'body': {'domain_href': 'https://api.gandi.net/v5/livedns/domains/iheartcli.com',  # noqa
                 ...
                 'domain_records_href': 'https://api.gandi.net/v5/livedns/domains/iheartcli.com/records',  # noqa
                 'fqdn': 'iheartcli.com',
                 'zone_href': 'https://api.gandi.net/v5/livedns/zones/397c514-e7cb-11e6-9429-00163e6dc886',  # noqa
                 'zone_records_href': 'https://api.gandi.net/v5/livedns/zones/397c514-e7cb-11e6-9429-00163e6dc886/records',  # noqa
    ...
    'https://api.gandi.net/v5/livedns/domains/iheartcli.com/records?sort_by=rrset_name': {  # noqa
        'status': 200,
        'headers': 'application/json',
        'body': [{'rrset_href': 'https://api.gandi.net/v5/livedns/domains/iheartcli.com/records/%40/A',  # noqa
                  'rrset_name': '@',
                  'rrset_ttl': 10800,
                  'rrset_type': 'A',
    ...
    'https://api.gandi.net/v5/livedns/domains/iheartcli.com/keys': {
        ...
        'headers': {'content-type': 'application/json',
                    'location': 'https://api.gandi.net/v5/livedns/domains/iheartcli.com/keys/3415833-2314-4a86-ba1c-c3c58608a168'},  # noqa
        'body': [{'algorithm': 13,
...
www 10800 IN CNAME webredir.vip.gandi.net."""  # noqa
    ...
    if method == 'PUT' and url == 'https://api.gandi.net/v5/livedns/domains/iheartcli.com/records/blog/CNAME':  # noqa
        content = {'message': 'DNS Record Created'}
    mock_resp = mock.Mock()
